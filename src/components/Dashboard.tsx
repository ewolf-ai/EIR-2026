    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          {/* Info Card */}
          <div className="bg-gradient-to-br from-pastel-peach to-pastel-sage bg-opacity-40 rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <div className="flex-shrink-0 w-8 h-8 bg-nursing-500 text-white rounded-full flex items-center justify-center font-bold">
                  1
                </div>
                <div>
                  <h4 className="font-semibold text-gray-800">Introduce tu número de plaza</h4>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800">Añade tus preferencias</h4>
                  <p className="text-sm text-gray-600">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800">Compara tu posición</h4>
                  <p className="text-sm text-gray-600">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800">Toma decisiones informadas</h4>
                  <p className="text-sm text-gray-600">
